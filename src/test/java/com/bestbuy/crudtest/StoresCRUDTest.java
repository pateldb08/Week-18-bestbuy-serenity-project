...
public class StoresCRUDTest extends TestBase {
    String name = "Mackenzie Chemist";
    String type = "Pharmacy";
    String address = "24 MollisonWay";
    String address2 = "Queensbury";
    String city = "Harrow";
    String state = "England";
    String zip = "HA8 5ql";
    int lat = 234;
    int lng = 567;
    String hours = "Monday - Friday : 9AM. to 6PM.; Saturday: 9AM. to 2PM.; Sunday: CLOSED";
